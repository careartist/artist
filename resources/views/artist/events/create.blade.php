            ...
            <div class="card-content">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <form class="form-horizontal" action="{{ route('events.store') }}" method="post">
                        ...
                        {{ Form::bsTextarea('description', null, ['placeholder' => 'Description', 'rows' => '5']) }}

                        <div class="form-group{{ $errors->has('start_at') ? ' has-error' : '' }}">
                            <label for="start_at" class="control-label">Start Date</label>
                            <div class="input-append date form_datetime">
                                <input type="text" class="form-control" value="{{ old('start_at') }}" name="start_at" id="start_at">
                        ...
                        <div class="form-group{{ $errors->has('place') ? ' has-error' : '' }}" id="places">
                            ...
                            <select id="place" class="form-control" name="place">
                                ...
                                <option value="{{ $place->id }}"@if(old('place') == $place->id) selected="selected"@endif>{{ $place->place }}</option>
